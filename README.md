...
The implementation can also be used for further experimentations like using different attack strategies, acf algorithms, evaluation metrics by adding their respective implementations. 
